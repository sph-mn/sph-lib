(library (sph lang itml)
  ...
  (define (itml-create-line-scm-expr a) (apply string-append "\\." (first a) ": " (tail a)))
  ...
  (define (handle-ascend-line-expr a nesting-depth)
    (apply string-append "\\" (first a) ": " (list-string-char-escape (tail a))))

  (define (handle-ascend-indent-expr a nesting-depth)
    (pair (string-append "\\" (first a)) (list-string-char-escape (tail a))))

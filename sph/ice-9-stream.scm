; see also srfi-41 as a possible successor
...
(library (sph ice-9-stream)
  ...
  (define (stream-fold-multiple proc arg . prev)
    ...
    (if (stream-null? arg) prev
      (apply stream-fold-multiple proc (stream-tail arg) (apply proc (stream-first arg) prev))))

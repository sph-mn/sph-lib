(define-test-module (test module sph time)
  ...
  (define-test (utc->date-2)
    ...
    (let loop ((year -2002) (month 1) (day 1))
      (if (< year 2002)
        (let*
          ( (expected (date-new year month day 0 0 0 0 0))
  ...
  (test-execute-procedures-lambda (greg-years->year 0 1 1 2 3 4 -1 0 -2 -1)
    ...
    (utc-start-last-week (unquote 2016-6-17) #(date 2016 12 26 0 0 0 0 0)
      (unquote 1981-12-27) #(date 1981 12 28 0 0 0 0 0)
      (unquote 1981-1-1) #(date 1981 12 28 0 0 0 0 0) (unquote 1972-12-31) #(date 1972 12 25 0 0 0 0 0))
    ...
    (utc-start-first-week (unquote 2016-6-17) #(date 2016 1 4 0 0 0 0 0)
      (unquote 1981-12-27) #(date 1980 12 29 0 0 0 0 0)
      (unquote 1981-1-1) #(date 1980 12 29 0 0 0 0 0) (unquote 1972-12-31) #(date 1972 1 3 0 0 0 0 0))
    ...
    (utc-from-date #(date 1970 1 1 0 0 0 0 0) 0
      #(date 2016 1 1 0 0 0 0 0) (unquote 2016-1-1)
      #(date 1981 1 1 0 0 0 0 0) (unquote 1981-1-1)
      #(date 1981 12 1 0 0 0 0 0) (unquote 1981-12-1)
      #(date 1973 1 1 0 0 0 0 0 0) (unquote 1973-1-1)
      #(date 1972 12 31 0 0 0 0 0 0) (unquote 1972-12-31)
      #(date 2015 12 28 0 0 0 0 0 0) (unquote 2015-12-28)
      #(date 2016 6 17 0 0 0 0 0) (unquote 2016-6-17)
      #(date 1992 1 1 0 0 0 0 0) (unquote 1992-1-1)
      #(date 0 1 1 0 0 0 0 0) (unquote negative-0-1-1)
      #(date -1 5 10 0 0 0 0 0) (unquote negative-1-5-10) #(date -7 12 28 0 0 0 0 0) (unquote negative-7-12-28))
    (utc->date (unquote 2000-12-31) #(date 2000 12 31 0 0 0 0 0)
      (unquote 1981-12-1) #(date 1981 12 1 0 0 0 0 0)
      (unquote 2016-6-17-11-32-59) #(date 2016 6 17 11 32 59 0 0)
      (unquote 2015-12-28) #(date 2015 12 28 0 0 0 0 0)
      (unquote 2016-1-1) #(date 2016 1 1 0 0 0 0 0)
      (unquote 1972-12-31) #(date 1972 12 31 0 0 0 0 0)
      (unquote 1973-1-1) #(date 1973 1 1 0 0 0 0 0) (unquote negative-2001-1-1) #(date -2001 1 1 0 0 0 0 0))

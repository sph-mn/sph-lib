(define-test-module (test module sph lang docl)
  ...
  (test-execute-procedures-lambda
    (itml->shtml "\\.docl-eval (+ 1 2\n  (- 3 1))\n" ((p 5))
      ...
      ((p "key" 7 "word" ": " "con" 3 "tent")) "\\.(docl-eval (+ 1 (- 2 1) 3))"
      ((p 5)) "\\\\keyword content"
      ((p "\\" "keyword content")) "\\docl-list a b\n  c\n  d\n    e f"
      ((p "a b" "c" (section (h2 "d") (div (p "e f"))))) "c \\.docl-text-reverse: \"ab\""
      ((p "c " "ba")))))

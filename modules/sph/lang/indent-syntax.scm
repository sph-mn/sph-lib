...
(export denoted-tree->indent-tree denoted-tree->indent-tree-lines
  indent-tree->denoted-tree indent-tree->prefix-tree
  indent-tree->range-delimited-tree line->indent-and-content
  prefix-tree->indent-tree prefix-tree-text
  read-indent-tree->denoted-tree read-indent-tree->prefix-tree
  read-indent-tree-element->denoted-tree string->indent-depth)
...
(define* (denoted-tree->indent-tree-lines a #:optional (base-depth 0) (indent-string "  "))
  (map (l (a) (string-append (string-multiply indent-string (+ base-depth (first a))) (tail a))) a))

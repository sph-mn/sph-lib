(define-module (sph libmagic))
(use-modules (sph) (system foreign) (sph string))
(export file->mime-types sph-libmagic-description string->mime-types)
...
(define foreign-magic-buffer
  (pointer->procedure pointer (dynamic-func "magic_buffer" libmagic) (list pointer pointer size_t)))

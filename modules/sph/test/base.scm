(define-module (sph test base))
(use-modules (sph) (sph record) (sph vector))

(export test-create-result test-result
  test-result-arguments test-result-expected
  test-result-index test-result-result
  test-result-success? test-result-title test-result? test-success?)

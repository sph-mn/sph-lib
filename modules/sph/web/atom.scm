(library (sph web atom)
  ...
  (define* (atom-category term #:key label scheme)
  ...
  (define* (atom-content-text . a) "[#:type string] sxml ... -> sxml"
    (apply atom-text (q content) a))
  ...
  (define*
    (atom-entry id title updated #:key authors categories content contributors link published
      rights
      source
      summary)
    "::

(define-module (sph time utc))
(use-modules (sph))

(export sph-time-utc-description utc-duration->hms
  utc-duration-from-hms utc-leap-second?
  utc-leap-seconds utc-nanoseconds-day
  utc-nanoseconds-hour utc-nanoseconds-minute
  utc-nanoseconds-week utc-seconds-day utc-tai->leap-second-difference)

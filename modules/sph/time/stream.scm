(define-module (sph time stream))
(use-modules (sph) (sph time) (sph time gregorian) (srfi srfi-41))
(export date-stream sph-time-stream-description)
  ...
  (let
    ...
    (stream-let loop
      ...
      (if
        ...
        (let (day-count (vector-ref (greg-month-days-get (greg-year-leap-year? year)) (- month 1)))
